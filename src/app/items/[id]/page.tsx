          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              <div className="md:col-span-2 aspect-video relative rounded-lg overflow-hidden">
                <Image src={item.images?.[0] || "https://www.signfix.com.au/wp-content/uploads/2017/09/placeholder-600x400.png"} alt={item.title} fill className="object-cover" />
              </div>
              {item.images?.slice(1, 3).map((image: string, index: number) => (
                <div key={index} className="aspect-square relative rounded-lg overflow-hidden">
                  <Image
                    src={image || "https://www.signfix.com.au/wp-content/uploads/2017/09/placeholder-600x400.png"}
